...
def generate_template(bottle):
    # Update keys to match your provided CSV headers
    return {
        "messages": [
            {
                "role": "system",
...
def main(csv_filepath, output_jsonl_filepath):
...
if __name__ == "__main__":
    ...
    output_jsonl_filepath = input("Enter the output JSONL file path: ")
    main(csv_filepath, output_jsonl_filepath)
